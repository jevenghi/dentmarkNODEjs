export const translations = {
  en: {
    ...
    kentekenNotFound: 'No vehicle found for this license plate',
    kentekenLookupFailed: 'Could not retrieve vehicle data',
  ...
  nl: {
    ...
    deleteImageButton: 'Afbeelding verwijderen',
    ...
    kentekenNotFound: 'Geen voertuig gevonden voor dit kenteken',
    kentekenLookupFailed: 'Voertuiggegevens konden niet worden opgehaald',
