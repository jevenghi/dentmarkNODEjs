...
exports.signup = catchAsyncError(async (req, res, next) => {
  ...
  try {
    ...
    res.status(201).json({
      status: 'success',
      message: `Please complete your registration, following the instructions sent to your e-mail address. If you haven't received the email, please check your spam folder`,
    });
  } catch (err) {
